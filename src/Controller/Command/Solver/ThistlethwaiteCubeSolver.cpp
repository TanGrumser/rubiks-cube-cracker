...
namespace busybin
{
   ...
   */
  ThistlethwaiteCubeSolver::ThistlethwaiteCubeSolver(RubiksCubeModel* pCube, ThreadPool* pThreadPool) :
   ...
   */
  void ThistlethwaiteCubeSolver::initialize(std::function<void()> onInitialized)
  {
